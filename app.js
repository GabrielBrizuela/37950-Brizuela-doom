...
const contenedores = document.getElementsByClassName('container-fluid');
console.log(contenedores);
const noExistente = document.getElementsByClassName('no-existe');
console.log(noExistente);
...
const noHay = document.getElementById('no-existe');
console.log(noHay);
